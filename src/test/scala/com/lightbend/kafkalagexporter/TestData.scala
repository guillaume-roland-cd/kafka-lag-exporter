...
trait TestData {
  ...
  val gtpSingleMember = GroupTopicPartition(
    groupId,
    clientId,
    consumerId,
    "/127.0.0.1",
    topicPartition0.topic,
    topicPartition0.partition
  )
  val gtp0 = GroupTopicPartition(
    groupId,
    clientId,
    consumerId,
    "/127.0.0.1",
  ...
  val gtp1 = GroupTopicPartition(
    groupId,
    clientId,
    consumerId,
    "/127.0.0.2",
    topicPartition1.topic,
    topicPartition1.partition
  )
  val gtp2 = GroupTopicPartition(
    groupId,
    clientId,
    consumerId,
    "/127.0.0.3",
    topicPartition2.topic,
    topicPartition2.partition
  )
  val gt2p0 = GroupTopicPartition(
    groupId,
    clientId,
    consumerId,
    "/127.0.0.4",
